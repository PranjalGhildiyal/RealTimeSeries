...
class WidgetDefinitions(ConfigReader):
    def __init__(self): 
        ...
        self.last_n= pn.widgets.IntInput(name='Enter `n`', value=1, sizing_mode= 'stretch_width')
        ...
        self.config_widgetbox= pn.WidgetBox(pn.Column(pn.Row(self.last_n, self.last_unit), pn.Row(self.feature_shape, self.n_indexes)), sizing_mode= 'stretch_width')
